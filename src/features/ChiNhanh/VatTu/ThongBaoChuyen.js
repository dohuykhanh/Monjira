...
const ThongBaoChuyen = ({ cart, setCart, handleChange,Data, setData }) => {
    ...
    //           }
        ...
        const handleclickxacthuc = () => {
            ...
            console.log("DataakhanhID1", Dataa[0].MaVT)
            console.log("DataakhanhID2", Data1.length)
            for(let i=0; i<Dataa.length; i++) {
              for(let j=0; j<Data1.length;j++){
                if(Dataa[i].MaVT===Data1[0][j].MaVT){
                ...
                //   console.log("DataakhanhSP5", Data1[j][i]._id)
                  ...
                  Gia = Data1[0][j].Gia;
                  TenVatTu = Data1[0][j].TenVatTu;
                  NgaySanXuat= Data1[0][j].NgaySanXuat;
                  NgayHetHan= Data1[0][j].NgayHetHan;
                  idd=Dataa[i]._id;
          
                  let sltruoc=Dataa[i].SoLuong;
                  let slsau=Data1[0][j].SoLuong;
                    ...
                    <table className='table table-striped table-hover table-bordered'>
                        ...
                        <tbody>
                            ...
                            <td></td>
                             ...
                             <Button size='sm' variant='primary'onClick={() => {handleclickxacthuc()}} >Xác Thực</Button>|
                             </td>
